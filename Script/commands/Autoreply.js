...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    ...
    "admin": "He is Fabu Lous Akash  তাকে সবাই Admin আক্কু হিসেবে চিনে😘☺️",
    ...
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss আক্কু এর ইনবক্সে গুতা দিন 😘",
    ...
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌আক্কু 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭💖",
    ...
    "valo aso": "হ্যাঁ রে প্রিও, বস আক্কু এর দোয়ায় ভালো আছি 😌💞",
    "pagol": "হুম পাগল, কিন্তু তোমারই পাগল 😏😂",
    "breakup": "চিন্তা করিস না… আক্কু  বস তো আছেই তোকে নতুন জন দিয়া দিবে 😎🔥",
    "tui ke": "আমি তোর বস আক্কু এর ChatBot 😏",
    "umm": "এতো Umm কেনো জানু… কিছু বলবা? 😉",
    "hmm": "Hmmm কিসের হুমম জানু 🥵",
    "love": "Love করলে সরাসরি আক্কু বস কে বল জানু 😻🔥"
    "ট্রিপ": "অফিসিয়াল ট্রিপ দুপর ৩ টায়  সবাই প্রস্তুত হও"
    "ট্রিপ ২": "অফিসিয়াল ট্রিপ রাত ১০ টা সবাই প্রস্তুত হও"
    "ট্রিপ ৩": "অফিসিয়াল ট্রিপ রাত ১২টায়  সবাই প্রস্তুত হও"
  };
